...
void introScreen()
{
	...
	glColor3f(0.5, 0, 0.5);
	renderBitmapString(-260, -60, GLUT_BITMAP_TIMES_ROMAN_24, "Yash Nihalani         (101916006)");
	renderBitmapString(-260, -90, GLUT_BITMAP_TIMES_ROMAN_24, "Laksh Mittal    (101916002)");
	renderBitmapString(-260, -120, GLUT_BITMAP_TIMES_ROMAN_24,"Bhavesh Madaan    (101916005)");
	glColor3f(1, 0.5, 0);
	renderBitmapString(40, -30, GLUT_BITMAP_TIMES_ROMAN_24, "INSTRUCTED BY->:");
...
void gameOverScreen() {
	...
	renderBitmapString(-30, -60, GLUT_BITMAP_TIMES_ROMAN_24, buffer);
